...
function [ avg_R, ste_R, reshuffled_avg, reshuffled_ste ] = celldensity_by_depth_NeuNNorm( sectionstruct, receptor, celltype, region, type, normalized, normedbyNeuN )
    ...
    for i = 1:length( substruct )
        ...
        if normedbyNeuN
           smoothed_cells = smoothed_cells ./ substruct(i).smoothed_celltypes;
        end
